...
./sbin/start-master.sh -h 10.22.1.6 -p 7081
...
#ssh john@10.22.1.7 "./AutoDP/sbin/start-slave.sh spark://10.22.1.6:$c"
#ssh john@10.22.1.8 "./AutoDP/sbin/start-slave.sh spark://10.22.1.6:$c"
#ssh john@10.22.1.9 "./AutoDP/sbin/start-slave.sh spark://10.22.1.6:$c"

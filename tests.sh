...
./bin/spark-submit --master spark://202.45.128.165:7081 --driver-memory 30g --executor-memory 30g --conf spark.executor.extraJavaOptions="-Xms30g" --conf spark.driver.maxResultSize="0" --class edu.hku.dp.original.SparkKMeans examples/target/scala-2.11/jars/spark-examples_2.11-2.2.0.jar /home/john/tpch-spark/dataset/ds/ds1.10_gen.csv 1 3 10 > outputOKM.txt 2> errOKM.txt
./bin/spark-submit --master spark://202.45.128.165:7081 --driver-memory0g --executor-memory 30g --conf spark.executor.extraJavaOptions="-Xms30g" --conf spark.driver.maxResultSize="0" --class edu.hku.dp.SparkKMeansDP examples/target/scala-2.11/jars/spark-examples_2.11-2.2.0.jar /home/john/tpch-spark/dataset/ds/ds1.10_gen.csv /home/john/tpch-spark/dataset/ds/ds1.10_a.csv 1 3 10 1 > outputKM.txt 2> errKM.txt
#******KMean local************
./bin/spark-submit --class edu.hku.dp.original.SparkKMeans examples/target/scala-2.11/jars/spark-examples_2.11-2.2.0.jar /home/john/tpch-spark/dataset/ds/ds1.10_a.csv 1 3 10 > outputOKM.txt
./bin/spark-submit --class edu.hku.dp.SparkKMeansDP examples/target/scala-2.11/jars/spark-examples_2.11-2.2.0.jar /home/john/tpch-spark/dataset/ds/ds1.10_a.csv /home/john/tpch-spark/dataset/ds/ds1.10_a.csv 1 3 10 1 > outputKM.txt